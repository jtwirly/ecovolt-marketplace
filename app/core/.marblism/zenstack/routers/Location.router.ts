...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.LocationInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).location.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.LocationInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).location.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.LocationInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).location.findFirst(input as any))),

        findMany: procedure.input($Schema.LocationInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).location.findMany(input as any))),
        ...
        count: procedure.input($Schema.LocationInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).location.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.LocationCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.LocationCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.LocationCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.LocationCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.LocationCountArgs>, 'cursor'>,
